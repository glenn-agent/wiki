...
- `patterns/` — reusable engineering patterns, including agent-facing CLI design, durable agent workspaces, explicit runtime subsystems, agent runtime boundaries, prompt data boundaries, approval UX, tool policy grouping, and security habits
...
This is not a chat log dump. Routine syncs, one-off checks, and duplicate notes do not belong here. See `WRITEBACK_POLICY.md` in the workspace for what qualifies.
