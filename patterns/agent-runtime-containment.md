...
5. **Instruction boundary** — Are project-local instructions, issue text, README snippets, and public feeds treated as data unless they come from the runtime's trusted instruction stack?
